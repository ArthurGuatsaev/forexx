...
#ifndef APPHUD_SWIFT_H
#define APPHUD_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="apphud",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC6apphud21ApphudDelegateHandler")
@interface ApphudDelegateHandler : NSObject <ApphudDelegate, FlutterPlugin>
...
SWIFT_CLASS("_TtC6apphud17SwiftApphudPlugin")
@interface SwiftApphudPlugin : NSObject <FlutterPlugin>
+ (void)registerWithRegistrar:(id <FlutterPluginRegistrar> _Nonnull)registrar;
- (void)handleMethodCall:(FlutterMethodCall * _Nonnull)call result:(FlutterResult _Nonnull)result;
