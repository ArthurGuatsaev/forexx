...
import 'package:forex_290/loading/domain/api/loading_api.dart';
import 'package:forex_290/loading/domain/model/loading_model.dart';
import 'package:forex_290/loading/domain/repositories/shared_repo.dart';

class LoadingRepo with VSharedPref {
  final StreamController<String> errorController;
  LoadingRepo({required this.errorController});
  final date = DateTime(2023, 12, 18);
